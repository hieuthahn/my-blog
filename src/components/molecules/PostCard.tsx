                    ...
                    <figure className="w-full aspect-[5/2] rounded-tl-md rounded-tr-md overflow-hidden">
                     ...
                     (max-width: 1200px) 50vw,
                      33vw"
                            ...
                            className="absolute inset-0 object-cover w-full h-full rounded-tl-md rounded-tr-md"
                        />
                    </figure>
                    <div className="absolute bottom-0 flex flex-wrap-reverse justify-end w-full px-4 py-2 mt-2 text-sm text-black z-100 gap-y-1 gap-x-1 dark:text-gray-100">
