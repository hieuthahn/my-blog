...
const en = {
    ...
    home: {
        ...
        categories: [
            {
                name: 'Knowledge',
                description: 'Related posts about programming knowledge and algorithms.',
            ...
            {
                name: 'Notion',
                description: 'Articles with content about Notion and utilities around Notion.',
                value: ['notion']
            },
            {
                name: 'Other',
    ...
    post: {
        published_at_by: (datetime: any, author: any, locale: string) => {
            ...
            const _datetime =
                duration.asHours() > 24 * days ? raw.format('DD/MM/YYYY HH:mm') : raw.fromNow();
